...
void TrackBall::mouseMove(const glm::ivec2 &position, float speed) {
//  glm::vec3 m_lastPosition(400,400,400);
  glm::vec3 m_lastPosition(1,0,0);
  glm::vec3 currentPosition(0,0,0.080f);
  currentPosition = -speed*currentPosition;
